...
export default function MobileFAQSection() {
  ...
  return (
    <section id="faq" className="py-16 px-4 bg-ink relative z-10 border-t border-cyan-500/20">
        ...
        <div className="space-y-3">
          {faqs.map((faq, idx) => {
            ...
            return (
              <div
                key={idx}
                className="rounded-2xl bg-white/5 border border-cyan-500/30 overflow-hidden backdrop-blur-sm"
              >
                <button
                ...
                <AnimatePresence>
                  {isOpen && (
                    <motion.div
                      ...
                      className="px-4 pb-4 text-xs text-gray-300 leading-relaxed border-t border-cyan-500/10 pt-3"
                    >
                      {faq.answer}
                    </motion.div>
                  )}
